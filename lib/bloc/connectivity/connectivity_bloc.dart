...
class ConnectivityBloc extends Bloc<ConnectivityEvent, ConnectivityState> {
  ...
  ConnectivityBloc(this._manager) : super(ConnectivityInitialState(ConnectivityResult.none)) {
  ...
  Stream<ConnectivityState> _mapConnectivityChangedToState(ConnectivityResult result) async* {
    ...
    if (connected) {
      yield ConnectivityOnlineState(result);
    } else {
      yield ConnectivityOfflineState(result);
    }
  }
